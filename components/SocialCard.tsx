...
export default function SocialsAndFooter() {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col bg-black text-white relative overflow-hidden font-sans">
      ...
      {/* SECTION: SOCIALS SLIDE */}
      <section className="flex-1 flex flex-col items-center justify-center relative z-10 py-20 md:pt-32 overflow-hidden">
        
        {/* Decorative Background Glow */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] md:w-[500px] md:h-[500px] bg-orange-500/10 rounded-full blur-[80px] md:blur-[100px] pointer-events-none" />
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className="text-center mb-10 md:mb-20 relative z-20 px-4"
        >
          ...
          <p className="mt-4 text-gray-400 text-sm md:text-lg tracking-wide">
            Follow the journey behind the scenes
          </p>
        </motion.div>

        {/* Fanned Cards Container 
            - Added 'scale-[0.65] md:scale-100' to shrink the whole assembly on mobile
            - Added 'origin-center' to ensure it scales from the middle
        */}
        <motion.div 
          className="relative w-full max-w-sm h-[350px] md:h-[450px] flex items-center justify-center cursor-pointer scale-[0.65] md:scale-100 origin-center"
          style={{ perspective: "1000px" }}
          initial="initial"
          whileHover="hover"
          whileTap="hover"
        ...
        {/* Social Links Row 
            - Changed to 'flex-col md:flex-row' to stack on mobile
            - Added 'gap-6 md:gap-8' for responsive spacing
        */}
        <div className="mt-10 md:mt-20 flex flex-col md:flex-row gap-6 md:gap-8 items-center justify-center text-sm font-bold uppercase tracking-[0.2em] relative z-20">
            <a 
              href="https://instagram.com" 
              target="_blank"
              rel="noopener noreferrer"
